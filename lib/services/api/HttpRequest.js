...
var HttpRequest = /** @class */ (function () {
    ...
    HttpRequest.prototype.fetch = function (methodName, data) {
        return this.axios.get(methodName, {
            params: data
        });
    };
    HttpRequest.prototype.create = function (methodName, data) {
        return this.axios.post(methodName, data);
    };
    HttpRequest.prototype.update = function (methodName, data) {
        return this.axios.put(methodName, data);
    };
    HttpRequest.prototype.patch = function (methodName, data) {
        return this.axios.patch(methodName, data);
    };
    HttpRequest.prototype.delete = function (methodName, id) {
        return this.axios.delete(methodName, { params: { id: id } });
    };
    HttpRequest.prototype.request = function (type, url, data) {
        var promise;
        switch (type) {
            case 'GET':
